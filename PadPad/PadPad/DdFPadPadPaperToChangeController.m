...
- (void)viewDidLoad
{
    ...
    _portrait = [NSArray arrayWithObjects:@"WholeBookCell",@"CurrentPageCell", nil];
    _landscape = [NSArray arrayWithObjects:@"WholeBookCell",@"BothPagesCell",@"LeftPageCell",@"RightPageCell", nil];
